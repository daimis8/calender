...
const asideCalenderInfo = setAsideCalender(currentDateInfo.year, currentDateInfo.month, currentDateInfo.monthName, currentDateInfo.daysInMonth, currentDateInfo.firstDayOfWeek, currentDateInfo.day);
let currentMonthShowing;
let currentYearShowing;
...
if (smallCalenderLeftArrow && smallCalenderRightArrow) {
    smallCalenderLeftArrow.addEventListener('click', () => {
        ...
        const asideCalenderInfo = setAsideCalender(calenderInfo.year, calenderInfo.month, calenderInfo.monthName, calenderInfo.daysInMonth, calenderInfo.firstDayOfWeek);
...
function getCalenderInfo(year, month, day) {
...
function setAsideCalender(year, month, monthName, daysInMonth, firstDayOfWeek, currentDay) {
    const asideCalenderHeader = document.querySelector('.aside-calender-month-year');
    if (asideCalenderHeader) {
...
function initializeDateTimeSelects(clickedDate) {
    const dateSelect = document.getElementById('eventDate');
    const startTimeSelect = document.getElementById('eventStartTime');
    const endTimeSelect = document.getElementById('eventEndTime');
